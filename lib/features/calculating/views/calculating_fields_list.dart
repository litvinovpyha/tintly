          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              try {
                ...
                controllers.putIfAbsent(fieldId, () => TextEditingController());
              } catch (_) {
                field = null;
              }
              ...
              if (priceState is PriceLoaded && field != null) {
                ...
                if (pricesForField.isNotEmpty &&
                  ...
                  final inputValue = inputValues[field.id] ?? 0;
                  final delta = inputValue * pricesForField[0].pricePerUnit;
                  if (delta != 0) {
                    context.read<CalculatingBloc>().add(UpdateTotal(delta));
                  }
                }
              }

              final controller = controllers[field!.id]!;
              controller.text = inputValues[field.id]?.toInt().toString() ?? '';
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: Padding(
                              ...
                              child: DropDown(
                                ...
                                selectedPrice: selectedPrices[field.id],
