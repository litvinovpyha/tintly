...
class PriceMasterDropDown extends StatefulWidget {
  final Field field;
  final CalculatorField calculatorField;

  const PriceMasterDropDown({
    super.key,
    required this.field,
  ...
  @override
  _PriceMasterDropDownState createState() => _PriceMasterDropDownState();
}

class _PriceMasterDropDownState extends State<PriceMasterDropDown> {
